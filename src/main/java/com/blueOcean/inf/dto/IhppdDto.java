...
public class IhppdDto{
	...
	private String CMPTNC_BROFFI_NM;
	...
	private String BERTH_LT; //접안시설규모_길이
	private String BERTH_BT; //접안시설규모_너비
	private String BERTH_HG; //접안시설규모_높이
	private String BERTH_HDG; //접안선수방위
	private String RESIDE_AT; //거주구분
	private String RESIDE_POPLTN_CO; //거주인구
